...
export default function PostgresBackups() {
  ...
  // Fetch VPS instances
  const { data: vpsInstances } = useQuery<VPSInstance[]>({
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">PostgreSQL Backups</h1>
        <p className="mt-1 sm:mt-2 text-sm text-gray-600">
          Create instant backups of your PostgreSQL databases
        </p>
      </div>
